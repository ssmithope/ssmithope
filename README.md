...
CRUD app with authentication, REST API integration, and MySQL backend.
...
Software Development Certificate (in progress)
Bachelor’s Degree in Applied Technology (in progress)
